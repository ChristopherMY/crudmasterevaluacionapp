...
import 'package:crudmasterevaluacion/clean_architecture/presentation/widget/shake_transition.dart';
...
class _EmployeeFormState extends State<EmployeeForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final employedBloc = context.watch<EmployedBloc>();
      ...
      child: Column(
        ...
        children: [
          ...
          if (employedBloc.isUpdated) ...[
            Text(
              "${employedBloc.daysBetween} dias para terminar el contrato",
